    ...
    <div className="py-8">
      ...
      {myProjects.map((project) => (
        <LinkPreview
          ...
          height={200}
        >
          <div className="mb-2 flex flex-col rounded bg-gray-100 px-2 transition-all hover:bg-gray-200 dark:bg-gray-800/30 dark:hover:bg-gray-800/50 md:flex-row md:bg-transparent">
            <img
              src={project.image}
              alt={project.title}
